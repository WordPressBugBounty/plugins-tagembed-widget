...
function __tagembed__manageEmbedCode() {
    ...
    if (widgetData) {
        ...
        __tagembed__html_embed_code.value = `<div class="tagembed-widget" style="width:100%;height:100%" data-widget-id="${__tagembed__widgetId}" view-url="https://widget.tagembed.com/${__tagembed__widgetId}"><script src="${__tagembed__plugin_react_url}embed.min.js" type="text/javascript"></script></div>`;

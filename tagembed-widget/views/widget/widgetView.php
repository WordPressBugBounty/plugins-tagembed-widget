...
<div id="__tagembed__widgetab" class="__tagembed__tabcontent">
	<div class="__tagembed__widgetarea">
		...
		<div class="__tagembed__widgetinn">
			...
			?>
					<div class="__tagembed__widgetbox <?php echo $__tagembed__active_widget_id == $__tagembed__widget->id ? 'active' : ''; ?>" id="<?php echo esc_attr('__tagembed__widgetbox' . $count); ?>">
						...
						<div class="__tagembed__widget_sourcecode" onclick="__tagembed__copyToWidgetShortCode('[tagembed widgetid <?php echo esc_js($__tagembed__widget->id); ?>]');">
						...
						<div class="__tagembed__widgetfoot">
							<ul>
								<li><a href="javascript:void(0);" onclick="__tagembed__menus(2, '<?php echo esc_js($__tagembed__widget->id); ?>')"> Open </a></li>
								<li>
									<a href="javascript:void(0);" onclick="__tagembed__widgetEditForm('<?php echo esc_js($__tagembed__widget->id); ?>', '<?php echo esc_js($__tagembed__widget->name); ?>');">
										Rename
									</a>
								</li>

								<li><a href="javascript:void(0);" onclick="__tagembed__deleteWidget('<?php echo esc_js($__tagembed__widget->id); ?>', '<?php echo esc_js('__tagembed__widgetbox' . $count); ?>');"> Delete </a></li>
							</ul>
						</div>
					</div>
			<?php

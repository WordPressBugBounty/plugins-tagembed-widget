...
if (!empty($__tagembed__widgets)) :
	wp_enqueue_script('__tagembed__script-networks-js', TAGEMBED_PLUGIN_URL . '/assets/js/network/tagembed.networks.script.js', ['jquery'], TAGEMBED_PLUGIN_VERSION, true);
	wp_enqueue_script('__tagembed__script-feed-create-js', TAGEMBED_PLUGIN_URL . '/assets/js/feed/tagembed.feed.create.script.js', ['jquery'], TAGEMBED_PLUGIN_VERSION, true);
	wp_enqueue_script('__tagembed__script-feed-js', TAGEMBED_PLUGIN_URL . '/assets/js/feed/tagembed.feed.script.js', ['jquery'], TAGEMBED_PLUGIN_VERSION, true);
?>

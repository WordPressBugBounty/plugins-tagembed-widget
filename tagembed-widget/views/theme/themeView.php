...
wp_enqueue_script('__tagembed__script-theme-js', TAGEMBED_PLUGIN_URL . '/assets/js/theme/tagembed.theme.script.js', ['jquery'], TAGEMBED_PLUGIN_VERSION, true);
/* Lazy Loader Script */
wp_enqueue_script('__tagembed__script-lazy-loading-js', TAGEMBED_PLUGIN_URL . '/assets/js/lazyload.js', ['jquery'], TAGEMBED_PLUGIN_VERSION, true);
